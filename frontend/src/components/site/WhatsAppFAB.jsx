...
export default function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 group inline-flex items-center gap-3 bg-[#25D366] text-white font-semibold rounded-full pl-3 pr-5 py-3 shadow-xl shadow-black/40 hover:scale-105 transition-transform"
    >
